...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
	...
	private static final long serialVersionUID = -23922448;

	/**
	 * The reference instance of <code>ferret.schema_version</code>
	 */
	...
	/**
	 * The column <code>ferret.schema_version.installed_rank</code>.
	 */
	...
	/**
	 * The column <code>ferret.schema_version.version</code>.
	 */
	...
	/**
	 * The column <code>ferret.schema_version.description</code>.
	 */
	...
	/**
	 * The column <code>ferret.schema_version.type</code>.
	 */
	...
	/**
	 * The column <code>ferret.schema_version.script</code>.
	 */
	...
	/**
	 * The column <code>ferret.schema_version.installed_on</code>.
	 */
	...
	/**
	 * The column <code>ferret.schema_version.execution_time</code>.
	 */
	...
	/**
	 * The column <code>ferret.schema_version.success</code>.
	 */
	...
	/**
	 * Create a <code>ferret.schema_version</code> table reference
	 */
	...
	/**
	 * Create an aliased <code>ferret.schema_version</code> table reference
	 */
	...
	private SchemaVersion(String alias, Table<SchemaVersionRecord> aliased, Field<?>[] parameters) {
		super(alias, Ferret.FERRET, aliased, parameters, "");
	}
