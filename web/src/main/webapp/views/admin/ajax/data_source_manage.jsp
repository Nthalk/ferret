...
<jsp:useBean id="dataSourceManage" scope="request" type="com.iodesystems.ferret.web.controllers.models.DataSourceManage"/>

<form:form id="dataSourceManageForm"
           modelAttribute="dataSourceManage"
           method="post">

    <div class="modal-header">
        <h4 class="modal-title">Managage DataSource: ${dataSourceManage.dataSource.name}</h4>
    </div>
